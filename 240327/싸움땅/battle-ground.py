...
# [0]:i, [1]:j, [2]: dir, [3]:power, [4]:gun, [5]:score 방향 : 0,1,2,3 (상우하좌)
players = {}
...
def leave(num,ci,cj,cd,cp,cg,cs):
    for k in range(4): # 현재 방향부터 시계 방향 90도씩 빈칸 찾기(최소한 내가 온(상대방이 온) 칸은 비어있음)
